class notion_heading_3_block : notion_heading_block
{
    ...
    notion_heading_3_block($text) : base("heading_3")
    {
        $this.heading_3 = [Heading_structure]::new($text)
    }

    notion_heading_3_block($text, $color) : base("heading_3")
    {
        $this.heading_3 = [Heading_structure]::new($text, $color)
    }

    notion_heading_3_block($text, [bool] $is_toggleable) : base("heading_3")
    {
        $this.heading_3 = [Heading_structure]::new($text, $is_toggleable)
    }

    notion_heading_3_block($text, $color, [bool] $is_toggleable) : base("heading_3")
    {
