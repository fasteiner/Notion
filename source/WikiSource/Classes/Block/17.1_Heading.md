...
classDiagram
    ...
    `Heading_structure` <.. `notion_heading_block`:uses
    `notion_block` --|> `notion_heading_block`:inherits
    `Heading_structure`--|> `notion_heading_1_block`:inherits
    `Heading_structure`--|> `notion_heading_2_block`:inherits
    `Heading_structure`--|> `notion_heading_3_block`:inherits
